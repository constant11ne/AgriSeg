        ...
        summary_rows.append(
            {
                ...
                "strongest_interaction_term": None if strongest_interactions.empty else str(
                    strongest_interactions.iloc[0]["pretty_term"]),
                "strongest_interaction_abs_coef": None if strongest_interactions.empty else float(
                    strongest_interactions.iloc[0]["abs_coef"]),
            }
        )
