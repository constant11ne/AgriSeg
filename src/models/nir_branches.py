...
def _dw_sep_conv(in_ch: int, out_ch: int, stride: int = 1, *, depth_norm_mode: str = "bn", point_norm_mode: str = "bn") -> nn.Sequential:
...
class NIREncoderLite(nn.Module):
    ...
    def __init__(
        ...
        self.stage1 = _dw_sep_conv(stem_ch, chs[0], stride=2, depth_norm_mode=stage1_norm_mode, point_norm_mode=stage1_norm_mode)
