...
class LateFusionWrapper(nn.Module):
    def __init__(self, rgb_model: nn.Module, nir_model: Optional[nn.Module] = None,
                 ndvi_model: Optional[nn.Module] = None, fusion_mode: str = "rgb_nir",
                 freeze_branches: bool = False) -> None:
        super().__init__()
...
class WeightedLogitsFusion(LateFusionWrapper):
    def __init__(self, rgb_model: nn.Module, nir_model: Optional[nn.Module] = None,
                 ndvi_model: Optional[nn.Module] = None, fusion_mode: str = "rgb_nir",
                 freeze_branches: bool = True) -> None:
...
class PerClassWeightedFusion(LateFusionWrapper):
    def __init__(self, rgb_model: nn.Module, nir_model: Optional[nn.Module] = None,
                 ndvi_model: Optional[nn.Module] = None, num_classes: int = 9, fusion_mode: str = "rgb_nir",
                 freeze_branches: bool = True) -> None:
        super().__init__(rgb_model, nir_model, ndvi_model, fusion_mode, freeze_branches)
...
def build_late_fusion(fusion_method: str, rgb_model: nn.Module, nir_model: Optional[nn.Module] = None,
                      ndvi_model: Optional[nn.Module] = None, num_classes: Optional[int] = None,
                      freeze_branches: bool = True, fusion_mode: str = "rgb_nir") -> nn.Module:
